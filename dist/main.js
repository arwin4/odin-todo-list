...
function renderTasks(project, renderProjectsContainer) {
  ...
  Object.values(tasks).forEach((task) => {
    ...
    dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, 'PP');
